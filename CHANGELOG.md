...
### Changed
- **Application ID**: Updated from `com.example.log2ramconfig` to `com.satoshihost.ssdsaver` for proper branding and domain ownership
...
- **Rebranded**: From "Log2Ram Config" to "SSDsaver"
  ...
  - New application ID: `com.satoshihost.ssdsaver`
